...
public:
        ...
        const Region_characteristics<ndim>& classifiers)
  {
    ...
    ViewVectorDouble children_left_coord("children_left", num_regions * ndim * children_per_region);
    ViewVectorDouble children_length("children_length", num_regions * ndim * children_per_region);
