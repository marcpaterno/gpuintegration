...
public:
                      ...
                      int it)
  {
    ...
    INTEGRATE_GPU_PHASE1<IntegT, NDIM>(
      ...
      // epsrel,
      // epsabs,
      /*constMem&*/ constMem.gpuG.data(),
      constMem.GPUScale.data(),
      constMem.GPUNorm.data(),
      constMem.gpuGenPermGIndex.data(),
      constMem.cRuleWt.data(),
      fEvalPerRegion,
      NSETS,
      lows.data(),
      highs.data(),
                      ...
                      Volume<T, NDIM>* vol = nullptr)
  {
    ...
    for (size_t it = 0; it < maxIters && terminate == false; it++) {
