                       ...
                       double* randoms = nullptr)
  {
    ...
    */
    ...
    for (int j = 1; j <= ndim; j++) {
      ...
      // interval random numbers close to one mean to the left of the interval
      // we multiply by dxg, which represents how many bins per interval there
      // are this multiplication scales to which of the 500 bins this lands on.
