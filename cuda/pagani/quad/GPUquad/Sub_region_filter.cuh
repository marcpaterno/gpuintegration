...
class Sub_regions_filter{
    ...
    size_t get_num_active_regions(int* active_regions, const size_t num_regions){
        ...
        cudaMemcpy(&last_element, active_regions + num_regions - 1,
                           sizeof(int),
                           cudaMemcpyDeviceToHost);
                           
        cudaMemcpy(&num_active, scanned_array + num_regions - 1,
                           sizeof(int),
                           cudaMemcpyDeviceToHost);
    ...
    size_t filter(Regions& sub_regions, 
