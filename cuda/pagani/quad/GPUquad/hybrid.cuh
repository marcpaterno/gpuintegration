...
void
two_level_errorest_and_relerr_classify(Region_estimates<ndim>& current_iter_raw_estimates, 
    ...
    quad::RefineError<double><<<numBlocks, block_size>>>(current_iter_raw_estimates.integral_estimates,
...
template<size_t ndim>
void
computute_two_level_errorest(Region_estimates<ndim>& current_iter_raw_estimates, 
    const Region_estimates<ndim>& prev_iter_two_level_estimates, 
