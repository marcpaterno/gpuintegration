...
TEST_CASE("get_num_active_regions: 100-region-list")
{
	...
	SECTION("All active regions")
	{
		...
		quad::cuda_memcpy_to_device<int>(regions.active_regions, host_active_regions, num_regions);
...
TEST_CASE("filter: all regions are active")
{
	...
	quad::cuda_memcpy_to_device<int>(classifications.active_regions, host_active_regions, n);
