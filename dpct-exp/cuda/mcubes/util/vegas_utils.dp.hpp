...
public:
  ...
  {
    localState = dpct::rng::device::rng_generator<
      oneapi::mkl::rng::device::philox4x32x10<4>>(
      0,
      {static_cast<std::uint64_t>(item_ct1.get_local_id(2)),
  ...
  operator()()
  {
    return localState.generate<oneapi::mkl::rng::device::uniform<double>, 1>();
  }
};
