...
T
dot_product(Kokkos::View<T*, Kokkos::CudaSpace> arr1, Kokkos::View<T*, Kokkos::CudaSpace> arr2)
{
...
T2
dot_product(Kokkos::View<T1*, Kokkos::CudaSpace> arr1, Kokkos::View<T2*, Kokkos::CudaSpace> arr2)
{
...
template <typename T, bool use_custom = false>
T
exclusive_scan(Kokkos::View<T*, Kokkos::CudaSpace> input, Kokkos::View<T*, Kokkos::CudaSpace> output)
{
  if constexpr (use_custom == false) {
