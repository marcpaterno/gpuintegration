...
int main(int argc, char** argv){
  ...
  double sum = 0.;
  sum += execute_integrand<F_2_5D, ndim>(point, num_invocations);
  sum += execute_integrand<F_3_5D, ndim>(point, num_invocations);
  sum += execute_integrand<F_4_5D, ndim>(point, num_invocations);
  sum += execute_integrand<F_5_5D, ndim>(point, num_invocations);
  sum += execute_integrand<F_6_5D, ndim>(point, num_invocations);
  printf("%.15e\n", sum);
