...
int main()
{
    ...
    /*std::cout<<"Results for warp-size 32\n";
    single_block_manual_block_reduce<32>();
    two_block_manual_block_reduce<32>();*/
    
    //two_block_reduce_over_work_group<32>();
    //single_block_reduce_over_work_group<32>();
    
    
        //this gives right results on Iris
    //std::cout<<"Results for warp-size 16\n";
    //single_block_manual_block_reduce<16>();
    //two_block_manual_block_reduce<16>();
    
   // two_block_reduce_over_work_group<16>();
    //single_block_reduce_over_work_group<16>();
    
    
    //std::cout<<"Results for warp-size 8\n";
    //single_block_manual_block_reduce<8>(); //try to comment out these two, see if it makes a difference 
   // two_block_manual_block_reduce<8>();
    
    //two_block_reduce_over_work_group<8>();
    //single_block_reduce_over_work_group<8>();
