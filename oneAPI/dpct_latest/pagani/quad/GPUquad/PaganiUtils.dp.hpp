...
#include "oneAPI/dpct_latest/pagani/quad/util/cudaApply.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/util/cudaArray.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/util/cudaUtil.h"
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Phases.dp.hpp"
...
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Rule.dp.hpp"

#include "oneAPI/dpct_latest/pagani/quad/GPUquad/hybrid.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Sub_regions.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Region_estimates.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Region_characteristics.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Sub_region_filter.dp.hpp"
#include "oneAPI/dpct_latest/pagani/quad/quad.h"
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/Sub_region_splitter.dp.hpp"
...
class Cubature_rules{
        ...
        bool compute_error = false)
    {
        ...
        dpct::get_default_queue().memcpy(ests, integral_estimates, sizeof(double)*num_regions);
        dpct::get_default_queue().memcpy(errs, error_estimates, sizeof(double)*num_regions);
