...
#include "oneAPI/dpct_latest/pagani/quad/GPUquad/heuristic_classifier.dp.hpp"
...
Workspace<ndim>::integrate(const IntegT& integrand,
  ...
  sycl::queue& q_ct1 = dev_ct1.default_queue();
            ...
            for(size_t it = 0; it < 700 && subregions.size > 0; it++){
                ...
                //std::cout<< "iter:"<< it << "\t" << cummulative.estimate + iter.estimate << "+-" << cummulative.errorest + iter.errorest << " (" << subregions.size << ")" << std::endl;
                           ...
                           quad::Volume<double, ndim>& vol)
{
    ...
    cuhreResult<double> result = integrate<IntegT, predict_split, collect_iters, collect_sub_regions>
