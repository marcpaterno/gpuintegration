...
namespace quad {
                ...
                size_t total_feval)
  {
    ...
    /*
    DPCT1026:32: The call to __ldg was removed because there is no
    correspoinding API in DPC++.
    */
    int posCnt = constMem->_gpuGenPermVarStart[feval_index + 1] -
                 /*
                 DPCT1026:33: The call to __ldg was removed because there is no
                 correspoinding API in DPC++.
                 */
    ...
    */
    ...
    for (int posIter = 0; posIter < posCnt; ++posIter) {
      ...
      if (pos == absPos) {
        /*
        DPCT1026:35: The call to __ldg was removed because there is no
        correspoinding API in DPC++.
        */
        g[absPos - 1] = constMem->_gpuG[gIndex * NDIM + posIter];
      } else {
        /*
        DPCT1026:36: The call to __ldg was removed because there is no
        correspoinding API in DPC++.
        */
        g[absPos - 1] = -constMem->_gpuG[gIndex * NDIM + posIter];
      }
