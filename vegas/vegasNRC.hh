...
struct VegasNRC{
  ...
  cubacpp::integration_result integrate(F f,
					double epsrel,
					double epsabs,
					typename cubacpp::integration_volume_for<F>::type vol
) const;
...
template<typename F>
  ...
  cuhreResult<double> integrate(F f,
				...
				double epsabs,
				quad::Volume<double,
				cubacpp::arity<F>()> const* vol) const;
...
template<typename F>
cubacpp::integration_result VegasNRC::integrate(F f,
						double epsrel,
						double epsabs,
  ...
  cuhreResult<double> res = vegas_book_integrate(f,
						 cubacpp::arity<F>(),
						 epsrel,
						 epsabs,
						 ncall,
...
template<typename F>
cuhreResult<double> VegasNRC::integrate(F f,
					double epsrel,
					double epsabs,
					quad::Volume<double, cubacpp::arity<F>()> const* vol)const{
  printf("invoking from vegasNRC.hh and using quad::Volume\n");
  //quad::Volume<double, cubacpp::arity<F>()> volume(vol.lows.data, vol->highs.data);
  cuhreResult<double> res = vegas_book_integrate(f, cubacpp::arity<F>(),
						 epsrel,
						 epsabs,
						 ncall,
						 vol,
