...
BoxIntegral8_22(double* x, double dim)
{
  double s = 22;
  double sum = 0;
  sum = pow(x[1], 2) + pow(x[2], 2) + pow(x[3], 2) + pow(x[4], 2) +
        pow(x[5], 2) + pow(x[6], 2) + pow(x[7], 2) + pow(x[8], 2);
  return pow(sum, s / 2);
}
...
{
  return cos(x[1] + 2. * x[2] + 3. * x[3] + 4. * x[4] + 5. * x[5] + 6. * x[6] +
             7. * x[7] + 8. * x[8]);
}
...
GENZ4_5D(double* x, double dim)
{
  ...
  return exp(
    -1.0 *
    (pow(25, 2) * pow(x[1] - beta, 2) + pow(25, 2) * pow(x[2] - beta, 2) +
     pow(25, 2) * pow(x[3] - beta, 2) + pow(25, 2) * pow(x[4] - beta, 2) +
...
{
  double beta = .5;
  double t1 = -10. * fabs(x[1] - beta) - 10. * fabs(x[2] - beta) -
              10. * fabs(x[3] - beta) - 10. * fabs(x[4] - beta) -
              10. * fabs(x[5] - beta) - 10. * fabs(x[6] - beta) -
              10. * fabs(x[7] - beta) - 10. * fabs(x[8] - beta);
  return exp(t1);
}
...
GENZ6_6D(double* x, double dim)
{
  if (x[6] > .9 || x[5] > .8 || x[4] > .7 || x[3] > .6 || x[2] > .5 ||
    ...
    return exp(10 * x[6] + 9 * x[5] + 8 * x[4] + 7 * x[3] + 6 * x[2] +
               5 * x[1]);
}
...
GENZ4_8D(double* x, double dim)
{
  ...
  return exp(
    ...
    (pow(25, 2) * pow(x[1] - beta, 2) + pow(25, 2) * pow(x[2] - beta, 2) +
     pow(25, 2) * pow(x[3] - beta, 2) + pow(25, 2) * pow(x[4] - beta, 2) +
     pow(25, 2) * pow(x[5] - beta, 2) + pow(25, 2) * pow(x[6] - beta, 2) +
     pow(25, 2) * pow(x[7] - beta, 2) + pow(25, 2) * pow(x[8] - beta, 2)));
}
...
GENZ3_8D(double* x, double dim)
{
  ...
  return pow(1 + 8 * x[8] + 7 * x[7] + 6 * x[6] + 5 * x[5] + 4 * x[4] +
               3 * x[1] + 2 * x[2] + x[3],
             -9);
}
...
oscill(double* rx, int dim)
{
  ...
  value =
    cos(value) - pow(2., (double)dim) * cosf(2. * M_PI + 0.5 * (double)dim) * p;
  return value;
}
  ...
  prodcub(double* rx, int dim)
{
  ...
  for (int i = 1; i <= dim; i++) {
    value *=
      (-2.4f * sqrt(7.) * (rx[i] - 0.5f) +
       8.f * sqrt(7.f) * (rx[i] - 0.5f) * (rx[i] - 0.5f) * (rx[i] - 0.5f));
  }
  return value;
}
