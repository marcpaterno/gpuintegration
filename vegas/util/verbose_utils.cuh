...
class IterDataLogger{
    ...
    public:
        ...
        void PrintIterResults(int iteration, double estimate, double errorest, double chi_sq, double iter_estimate, double iter_errorest){
            iterations_myfile << iteration     << ","
                << estimate   << ","
                << errorest      << ","
                << chi_sq   << "," 
                << iter_estimate       << ","
