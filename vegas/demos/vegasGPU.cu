...
main()
{
  ...
  // VegasGPU <GENZ_2_2D, ndim>(d_integrand);								     //from
  // 0-.5 and 0-.75 the right answer is 11564.5005525392916752025 from 0-.5 and
  // 0-.5 the right answer is  5858.50661482437226368347;
  return 0;
}
